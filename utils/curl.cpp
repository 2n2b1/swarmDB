...
// todo: remove the depencance on libCurl :  https://github.com/paularchard/bzchallenge/blob/master/src/url_reader.cpp
namespace
{
...
{
    std::string
    perform_curl_request(const char* url, const std::string& request)
    {
